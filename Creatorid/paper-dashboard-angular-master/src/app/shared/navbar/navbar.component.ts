...
export class NavbarComponent implements OnInit{
    ...
    getTitle() {
      const titlee = this.location.prepareExternalUrl(this.location.path()).split('/')[1]; // Obtenez le segment de l'URL après le premier slash (/)
      switch (titlee) {
        case 'getAllPortlets':
              return 'Portlets';
        case 'AddPortlet':
        ...
        case 'chart/affecterPortletAChart/:idChart/:idPortlet':
         ...
         case 'datasource/details/:id':
            return 'Datasources';
         case 'Datsource/affecterChartADatasource/:idDatasource/:idChart':
             return 'Datasources';
